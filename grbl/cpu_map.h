...
#endif
#define MIN_LIMIT_BIT_0 5 // X Limit Min (Axis 1) - Pin D3
#define MIN_LIMIT_BIT_1 1 // Y Limit Min (Axis 2) - Pin D14
#define MIN_LIMIT_BIT_2 5 // Z Limit Min (Axis 3) - Pin D59 //No Z Min
#if N_AXIS > 3
#define MIN_LIMIT_BIT_3 2 // Axis number 4 : D19
#endif
#if N_AXIS > 4
#define MIN_LIMIT_BIT_4 1 // Axis number 5 - Pin 40 : D19 //No Z Min
#endif
#if N_AXIS > 5
...
#endif
#if N_AXIS > 4
#define MAX_LIMIT_PORT_4 J
#endif
#if N_AXIS > 5
#define MAX_LIMIT_PORT_5 F // (Ramps Aux-3 D58)
#endif
#define MAX_LIMIT_BIT_0 4 // X Limit Max (Axis 1) - Pin D2 //Not Used
#define MAX_LIMIT_BIT_1 7 // Y Limit Max (Axis 2) - Pin D42 // Not Used
#define MAX_LIMIT_BIT_2 3 // Z Limit Max (Axis 3) - Pin D18
#if N_AXIS > 3
#define MAX_LIMIT_BIT_3 5 // Axis number 4 : Pin D44 //Not Used
#endif
#if N_AXIS > 4
#define MAX_LIMIT_BIT_4 0 // Axis number 5 : Pin D15
#endif
#if N_AXIS > 5
