...
#define HOMING_CYCLE_0 ((1 << AXIS_5) | (1 << AXIS_3))
...
#define HOMING_CYCLE_0 ((1 << AXIS_5) | (1 << AXIS_3))   // Home Z axis first to clear workspace.
